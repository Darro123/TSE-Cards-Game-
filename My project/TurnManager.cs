...
public class TurnManager : MonoBehaviour
{
    ...
    {
        GameLogUI.Instance.AddMessage("StartPlayerTurn" + currentPlayerIndex);
        ...
        if (current.skipNextTurn)
        {
            ...
            GameLogUI.Instance.AddMessage(current.playerName + " skipped!");
            EndTurn();
            return;
        }
    ...
    public void PlayCardFaceDown(Card card, GameObject target, bool bluffing, string claim)
    {
        ...
        GameLogUI.Instance.AddMessage(CurrentHand().playerName + " plays a card face down and claims: " + claim);
    }
